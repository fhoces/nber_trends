...
start.time <- Sys.time()
df <- scrape.nber.f(papers.var = 1:1000)
...
## Download data from Dataverse/OSF
...
```{r}
load("~/Desktop/sandbox/trends/all_NBER_Papers_v1.RData")
```
...
#Percentage of women by category by year
df3 <- tapply(temp3$gender!='male', 
              INDEX = list(temp3$date1, temp3$categories), 
